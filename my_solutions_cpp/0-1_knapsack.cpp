...
int OptimumSubjecToCapacity(const vector<Item>& items, int capacity) {
    // V[i][j] holds the optimum value when we choose from the first i items and
...
// Returns the optimum value when we choose from the first k items and have a
